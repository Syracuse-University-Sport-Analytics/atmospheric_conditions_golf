...
#pga_tour_data_w_weather %>% filter(mult_locations != 1, missing_weather != 1, round_num < 3) -> round_level_data
pga_tour_data_w_weather %>% filter(mult_locations != 1, missing_weather != 1, !is.na(round_score)) -> round_level_data
#pga_tour_data_w_weather %>% filter( missing_weather != 1, !is.na(round_score)) -> round_level_data
...
```
player season FE - this is very slow
```{r}

# round_level_data %>% lm(formula = round_score ~ air_density +  avg_dew_point + avg_wind_speed + avg_wind_gust + avg_humidity + sum_precipitation + teetimeinmin + factor(round_num) + event_name + player_name:factor(year), data = .) -> air_density_model_round_score
# #air_density_model_round_score %>% summary()
# saveRDS(air_density_model_round_score,"models/air_density_model_round_score_player_season_FE.RDS")
# 
# round_level_data %>% lm(formula = round_score ~ avg_pressure + avg_temperature + elevation + avg_dew_point + avg_wind_speed + avg_wind_gust + avg_humidity + sum_precipitation + teetimeinmin + factor(round_num) + event_name + player_name:factor(year), data = .) -> air_density_components_model_round_score
# #air_density_components_model_round_score %>% summary()
# saveRDS(air_density_components_model_round_score,"models/air_density_components_model_round_score_player_season_FE.RDS")
# 
# round_level_data %>% lm(formula = true_sg_total ~ air_density +  avg_dew_point + avg_wind_speed + avg_wind_gust + avg_humidity + sum_precipitation + teetimeinmin + factor(round_num) + event_name + player_name:factor(year), data = .) -> air_density_model_sg_total #need to calculate true_sg_total
# #air_density_model_sg_total %>% summary()
# saveRDS(air_density_model_sg_total,"models/air_density_model_sg_total_player_season_FE.RDS")
# 
# round_level_data %>% lm(formula = true_sg_total ~ avg_pressure + avg_temperature + elevation + avg_dew_point + avg_wind_speed + avg_wind_gust + avg_humidity + sum_precipitation + teetimeinmin + factor(round_num) + event_name + player_name:factor(year), data = .) -> air_density_components_model_sg_total
# #air_density_components_model_sg_total %>% summary()
# saveRDS(air_density_components_model_sg_total,"models/air_density_components_model_sg_total_player_season_FE.RDS")
# 
# #tab_model(air_density_model_round_score, air_density_components_model_round_score, air_density_model_sg_total, air_density_components_model_sg_total, digits = 3)
```
...
# round_level_data %>% lm(formula = round_score ~ air_density +  avg_dew_point + avg_wind_speed + avg_wind_gust + avg_humidity + sum_precipitation + teetimeinmin + factor(round_num) + event_name + player_name, data = .) -> air_density_model_round_score
# #air_density_model_round_score %>% summary()
# saveRDS(air_density_model_round_score,"models/air_density_model_round_score_player_event_FE.RDS")
# 
# round_level_data %>% lm(formula = round_score ~ avg_pressure + avg_temperature + elevation + avg_dew_point + avg_wind_speed + avg_wind_gust + avg_humidity + sum_precipitation + teetimeinmin + factor(round_num) + event_name + player_name, data = .) -> air_density_components_model_round_score
# #air_density_components_model_round_score %>% summary()
# saveRDS(air_density_components_model_round_score,"models/air_density_components_model_round_score_event_player_FE.RDS")
# 
# round_level_data %>% lm(formula = true_sg_total ~ air_density +  avg_dew_point + avg_wind_speed + avg_wind_gust + avg_humidity + sum_precipitation + teetimeinmin + factor(round_num) + event_name + player_name, data = .) -> air_density_model_sg_total #need to calculate true_sg_total
# #air_density_model_sg_total %>% summary()
# saveRDS(air_density_model_sg_total,"models/air_density_model_sg_total_event_player_FE.RDS")
# 
# round_level_data %>% lm(formula = true_sg_total ~ avg_pressure + avg_temperature + elevation + avg_dew_point + avg_wind_speed + avg_wind_gust + avg_humidity + sum_precipitation + teetimeinmin + factor(round_num) + event_name + player_name, data = .) -> air_density_components_model_sg_total
# #air_density_components_model_sg_total %>% summary()
# saveRDS(air_density_components_model_sg_total,"models/air_density_components_model_sg_total_event_player_FE.RDS")
# 
# #tab_model(air_density_model_round_score, air_density_components_model_round_score, air_density_model_sg_total, air_density_components_model_sg_total, digits = 3)
```
...
# bptest(air_density_model_round_score_no_teetime) #less than 0.05, reject indicating Heteroskedasticity
# dwtest(air_density_model_round_score_no_teetime)
# tab_model(air_density_model_round_score_no_teetime, digits = 4, rm.terms = player_fe, vcov.fun = "HAC", show.se = TRUE)
# unname(sqrt(diag(sandwich::vcovHAC(air_density_model_round_score_no_teetime))))
...
#tab_model(air_density_components_model_round_score, air_density_model_round_score, digits = 4, rm.terms = player_fe, file = "tables/total_strokes.html", vcov.fun = "HAC", show.se = TRUE)

#tab_model(air_density_components_model_round_score, air_density_model_round_score, digits = 4, rm.terms = player_fe, file = "tables/total_strokes.doc", vcov.fun = "HAC", show.se = TRUE) #, vcov.fun = "CL", vcov.args = list(type = "HC3"), show.se = TRUE
...
tab_model(air_density_components_model_sg_total, air_density_model_sg_total, digits = 4, rm.terms = player_fe, file = "tables/sg_total_robust.doc", vcov.fun = "CL", vcov.args = list(type = "HC1"), show.se = TRUE) #, vcov.fun = "CL", vcov.args = list(type = "HC3"), show.se = TRUE
...
tab_model(air_density_components_model_driving_dist, air_density_model_driving_dist, digits = 4, rm.terms = player_fe, file = "tables/driving_dist_robust.doc", vcov.fun = "CL", vcov.args = list(type = "HC1"), show.se = TRUE) #, vcov.fun = "CL", vcov.args = list(type = "HC3"), show.se = TRUE
...
# pdf("visualizations/sg_total_ME.pdf")
# 
# air_density_model_sg_total_plots <- me_plots(air_density_model_sg_total, c("air_density", "avg_dew_point", "avg_wind_speed", "avg_wind_gust", "sum_precipitation"))
# 
# ggarrange(plotlist = air_density_model_sg_total_plots)
# 
# air_density_components_model_sg_total_plots <- me_plots(air_density_components_model_sg_total, c("elevation","avg_temperature", "avg_humidity" , "avg_pressure" , "avg_dew_point" ,"avg_wind_speed" , "avg_wind_gust", "sum_precipitation"))
# 
# ggarrange(plotlist = air_density_components_model_sg_total_plots)
# 
# dev.off()
...
#the only thing interesting that I see is that the effect of teatime of ott and putt are reversed. If we decide not to use the sg types, we should just use total strokes to avoid the complexity of true sg. 
...
tab_model(air_density_model_driving_dist, air_density_model_driving_acc, air_density_components_model_driving_dist, air_density_components_model_driving_acc, digits = 4, rm.terms = player_fe, file = "tables/driving_air_density.html", vcov.fun = "CL", vcov.args = list(type = "HC3"), show.se = TRUE) #, vcov.fun = "CL", vcov.args = list(type = "HC3"), show.se = TRUE
...
library(lmtest)
bptest(air_density_model_driving_dist) #less than 0.05, reject indicating Heteroskedasticity
dwtest(air_density_model_driving_dist)


bptest(air_density_model_sg_total) #less than 0.05, reject indicating Heteroskedasticity
dwtest(air_density_model_sg_total)
